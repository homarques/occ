...
% INPUT
%   X       Dataset
%   LAMBDA  Regularisation parameter (default: no regularisation)
...
%
% DESCRIPTION
% Perform a linear regression on dataset X, with regularisation
...
% Copyright: D.M.J. Tax, D.M.J.Tax@tudelft.nl
