...
%dd_avprec      average precision of the Precision-Recall curve
%dd_auprc       area under the precision-recall curve
%dd_youdenJ     Youden J statistic
%dd_costc       cost curve
...
%fp_given_fn    estimate the false pos.rate, give a false neg. rate
%fn_given_fp    estimate the false neg.rate, give a false pos. rate
%
%Plot functions.
%--------------
...
%dd_ex16        crossvalidation on a kernel classifier
%
