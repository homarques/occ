...
class DeepSAD(object):
    ...
    def set_network(self, dim, N):
        """Builds the neural network phi."""
        self.N = N
        self.dim = dim
        self.net = build_network(dim = dim, N = N)
    ...
    def train(self, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 50,
        ...
        self.scaler = dataset.train_set.scaler
        self.minmax_scaler = dataset.train_set.minmax_scaler
    ...
    def pretrain(self, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 100,
        ...
        self.ae_net = build_autoencoder(self.dim, self.N)
