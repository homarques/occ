...
%   NRITERS  Number of iterations to perform EM (default = 100)
%   FIXEDCL  Indicator to fix the first class or not (default = 0)
...
%   
% DESCRIPTION
% Apply Expectation-Maximization to update the MEANS, INVCOVS and PRIORS
% of a MoG on the dataset X. NRITERS update iterations are performed.
...
%
% SEE ALSO
% mog_P, mog_dd, mog_init, mog_update
